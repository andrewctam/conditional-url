...
<template>
    <div class="lg:w-1/2 md:w-3/4 w-[95%] bg-black/10 my-8 mx-auto border border-black/25 rounded-xl text-center relative">
        <div v-if='selected === "" '>
            <span @click='$emit("close")' class="absolute top-1 left-2 text-xl text-white hover:text-red-200 cursor-pointer ">
                ←
            </span>

            <div class="mx-auto mt-4 text-white font-extralight text-2xl">
                Your URLs
            </div>
