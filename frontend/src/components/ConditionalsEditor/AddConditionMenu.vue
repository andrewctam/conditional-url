...
<template>
    <div class = "p-2 ml-3 mb-1 w-fit bg-gray-300/20 rounded-xl rounded-tl-none cursor-default text-center">
        <form @submit.prevent="checkAndCreate" class = "flex items-center"> 
            ...
            <input v-if="selectedVariable === 'Date'" v-model="value" class = "bg-transparent border border-black/50 h-8 mr-1 rounded font-light pl-1 text-white placeholder:text-white/50" type="date">
            <input v-if="selectedVariable === 'Screen Width' || selectedVariable === 'Screen Height'" v-model="value" class = "bg-transparent border border-black/50 h-8 mr-1 w-24 rounded font-light pl-1 text-white placeholder:text-white/50" type="number">
            ...
            <button type="submit" class = "hover:bg-green-100 bg-green-100/75 border border-black/50 rounded h-8 py-1 px-2 text-sm font-light">
                Add
            </button>
        </form>
